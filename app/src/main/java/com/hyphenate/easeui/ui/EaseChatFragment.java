...
//        messageList.setAvatarShape(1);
    ...
    protected void setUpView() {
        ...
        if (chatType == EaseConstant.CHATTYPE_SINGLE) {
            ...
            titleBar.setRightImageResource(R.drawable.icon_my);
            titleBar.setLeftImageResource(R.drawable.icon_fh);
        } else {
        ...
        titleBar.setRightLayoutClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (chatType == EaseConstant.CHATTYPE_SINGLE) {
                    ...
                    intent.setClass(getContext(), OtherPeopleActivity.class);
    ...
    private void getPeopleUid() {
        Map<String, String> params = new HashMap<>();
        params.put("phone",toChatUsername);
        OkHttpUtils.post()//
                .params(params)//
                    ...
                    public void onResponse(BeanResult response, int id)
                    {
                        if (response.code.equals("200")) {
                            try {
                                ...
                                uid = huan.uid;
                                titleBar.setTitle(huan.user_name);
