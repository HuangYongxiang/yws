...
public class FansPersonActivity extends BaseActivity {
    ...
    public void initView() {
        ...
        final LinearLayoutManager layoutManager = new LinearLayoutManager(FansPersonActivity.this);
        ...
        TextView textView = new TextView(FansPersonActivity.this);
    ...
    private void getData() {
        String url = Constants.RequestUrl + Constants.userFansUrl;
        ...
        OkHttpUtils.post()//
                ...
                .execute(new GenericsCallback<BeanResult>(new JsonGenericsSerializator())
                {
                    ...
                    public void onError(Call call, Exception e, int id)
                    {
                        ...
                        ToastUtil.show(FansPersonActivity.this,"网络异常");
                    }
