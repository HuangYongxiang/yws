...
public class SexActivity extends BaseActivity {
    ...
    private void goSelectGallery(int num) {
        ...
        Intent intent = new Intent(SexActivity.this, ImageGridActivity.class);
        ...
        if (resultCode == ImagePicker.RESULT_CODE_ITEMS) {
            if (data != null && requestCode == Constants.IMAGE_PICKER) {
                ...
                if(biaoshi.equals("1")){
                    ...
                    Glide.with(SexActivity.this).load(url1).centerCrop().crossFade().error(R.drawable.icon_tjtp).skipMemoryCache(false).into(img_zeng);
                    if(url1==null){
